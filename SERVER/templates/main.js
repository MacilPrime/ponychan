...
var styles = {
	{% endraw %}
	{% for stylesheet in stylesheets %}{% raw %}'{% endraw %}{{ stylesheet.name|addslashes }}{% raw %}' : '{% endraw %}{{ stylesheet.uri|addslashes }}{{ stylesheet.version|addslashes }}{% raw %}',
	{% endraw %}{% endfor %}{% raw %}
};
...
var siteroot = '{% endraw %}{{ config.root }}{% raw %}';

{% endraw %}{% if config.google_analytics %}{% raw %}

var _gaq = _gaq || [];
_gaq.push(['_setAccount', '{% endraw %}{{ config.google_analytics }}{% raw %}']);
{% endraw %}{% if config.google_analytics_domain %}{% raw %}
_gaq.push(['_setDomainName', '{% endraw %}{{ config.google_analytics_domain }}{% raw %}']);
