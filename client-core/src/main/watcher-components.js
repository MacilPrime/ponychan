...
export class WatcherMenu extends React.Component {
  static propTypes = {
  ...
  shouldComponentUpdate(prevProps) {
    return prevProps.mod !== this.props.mod ||
      prevProps.threads !== this.props.threads ||
      prevProps.onRemove !== this.props.onRemove;
  }
}
...
export class Thread extends React.Component {
  ...
  shouldComponentUpdate(prevProps) {
    return prevProps.thread !== this.props.thread;
  }
}
