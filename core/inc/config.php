 ...
 */
	...
	$config['banners'][] = array('colshy-groovy.jpg', 600, 150);
	...
	$config['banners'][] = array('evamena-rvb.jpg', 600, 150);
	$config['banners'][] = array('fen-sweetie.jpg', 600, 150);
	$config['banners'][] = array('forever.jpg', 600, 150);
	$config['banners'][] = array('knight-derpy.jpg', 600, 150);
	$config['banners'][] = array('knight-logo.jpg', 600, 150);
	$config['banners'][] = array('knight-mario.gif', 600, 150);
	$config['banners'][] = array('knight-terminal.gif', 600, 150);
	...
	$config['banners'][] = array('sersys-maud.jpg', 600, 150);
	$config['banners'][] = array('sersys-menu.gif', 600, 150);
	...
	$config['banners'][] = array('z-taco%20tuesday.jpg', 600, 150);
