 ...
 */
	...
	// Always act as if they had typed "noko" in the email unless they used "nonoko"
 ...
 */
	...
	$config['error']['flood_threads']		= _('You have hit the rate limit for creating new threads on this board. You must wait before creating more threads.');
	...
	$config['error']['noisy_video']		= _('Only silent video files are allowed on this board.');
